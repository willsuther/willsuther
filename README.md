...
- **Statistical Modeling**: Regression, ANOVA, MLE, factor analysis, and survey calibration techniques  
- **Business Intelligence**: Tableau dashboards, Alteryx ETL pipelines, KPI automation  
- **Consulting Projects**: Data architecture, risk modeling, and performance analytics for Nova Scotia businesses  
- **Academic Research**: Thesis on iterative calibration weighting for complex surveys  
- **Teaching & Mentorship**: Instructor and guest lecturer in applied statistics at Acadia University
...
- 📄 [Resume](#)  
- 🔗 [LinkedIn](https://linkedin.com/in/william-sutherland-1621b61a2)  
- 🏌️ Ask me about golf handicaps, running routes, or RStudio tips!
